...
" Should be removed after the work with Message.h
syn keyword arduinoConstant COMMAND_LENGTH OUTPUT_LENGTH
syn keyword arduinoMethod serialize deserialize empty
syn keyword arduinoModule Message Wire
syn keyword arduinoMethod beginTransmission endTransmission requestFrom send receive
syn keyword arduinoMethod onReceive onRequest
